Imports System
Imports System.Text
Imports Opto22.Ip4	 ' this is from the reference OptoMMP3.dll


Public Class Form1
	' Tcp_Client is a sub-assembly of the OptoMMP3.dll, this must be added as a
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (Not bRunning) Then
			...
			' 22500 is the starting location of SNAP Serial Module TCP/IP ports (22500 may be modified in the security area of the SNAP-PAC I/O unit)
            i32Port = 22500 + i32Module * 2 + i32Channel

			' open the connection with a timeout
			i32Result = objTcpClient.Open(textIpAddress.Text, i32Port, 1000)
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
		...
		' This is just a timer based example when applications don't need a lot of performance.
		' If performance is a critical topic, instantiate a thread and poll the TCP session.
		'
