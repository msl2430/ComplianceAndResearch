// CLR Test App.cpp : main project file.

#include "stdafx.h"
#include "windows.h"

using namespace System;
using namespace OptoMMP2;
...
int main(array<System::String ^> ^args)
{
  ...
  i32Result = objMmp.Open("10.192.54.46",2001,OptoMMP2::OptoMMP::Connection::UdpIp,3000,true);
  if(i32Result < 0)
  {
  ...
  i32Result = objMmp.WriteDigitalPointConfiguration64(objMmp.GetPointNumberFor64(1,0),true,OptoMMP2::OptoMMP::eDigitalFeature::None,false,false);
  if(i32Result < 0)
  {
    Console::WriteLine(L"i32Result is {0}",i32Result);
  }
  i32Result = objMmp.WriteDigitalPointConfiguration64(objMmp.GetPointNumberFor64(1,1),true,OptoMMP2::OptoMMP::eDigitalFeature::None,false,false);
  if(i32Result < 0)
  {
    Console::WriteLine(L"i32Result is {0}",i32Result);
  }
  i32Result = objMmp.WriteDigitalPointConfiguration64(objMmp.GetPointNumberFor64(1,2),true,OptoMMP2::OptoMMP::eDigitalFeature::None,false,false);
  if(i32Result < 0)
  {
    Console::WriteLine(L"i32Result is {0}",i32Result);
  }
  i32Result = objMmp.WriteDigitalPointConfiguration64(objMmp.GetPointNumberFor64(1,3),true,OptoMMP2::OptoMMP::eDigitalFeature::None,false,false);
  if(i32Result < 0)
  {
    Console::WriteLine(L"i32Result is {0}",i32Result);
  }
